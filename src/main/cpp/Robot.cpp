...
ctre::phoenix::motorcontrol::can::WPI_TalonSRX leftf{1};;   //left front motor is a talon
ctre::phoenix::motorcontrol::can::WPI_TalonSRX leftb{5};    //left back motor is a talon
frc::SpeedControllerGroup leftDrive{leftf, leftb};          //combine front and back motors

ctre::phoenix::motorcontrol::can::WPI_TalonSRX rightf{2};   //right front motor is a talon
ctre::phoenix::motorcontrol::can::WPI_TalonSRX rightb{4};   //right back motor is a talon
frc::SpeedControllerGroup rightDrive{rightf, rightb};       //combine front and back motors
...
ctre::phoenix::motorcontrol::can::WPI_TalonSRX intake{0};
ctre::phoenix::motorcontrol::can::WPI_TalonSRX outtake{3};
ctre::phoenix::motorcontrol::can::WPI_TalonSRX shooter{6};
ctre::phoenix::motorcontrol::can::WPI_TalonSRX climberDown{7};


//SparkMax and Reg spark initialization
frc::PWMSparkMax index2{9};
